...
parkLoader.load('models/digiPark.gltf', function (park) {
...
let veemonLoader=new THREE.GLTFLoader().load('models/veemon.gltf',function(vee){
    ...
    vee.scene.scale.set(5,5,5);
    vee.scene.position.y = -1.50;
    scene.add(vee.scene);
...
// let flamedramonLoader=new THREE.GLTFLoader().load('models/veemon.gltf',function(flame){
//     console.log(flame);   
...
//             child.receiveShadow = true; }
//     })
//     flame.scene.scale.set(5,5,5);
//     flame.scene.position.y = -1.50;
//     // scene.add(flame.scene);
// });

// let magnamonLoader=new THREE.GLTFLoader().load('models/veemon.gltf',function(magna){
//     console.log(magna);   
...
//             child.receiveShadow = true; }
//     })
//     magna.scene.scale.set(5,5,5);
//     magna.scene.position.y = -1.50;
